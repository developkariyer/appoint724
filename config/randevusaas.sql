...
START TRANSACTION;
USE `randevusaas`;
INSERT INTO `randevusaas`.`businesses` (`id`, `name`, `slug`, `timezone`, `created_at`, `updated_at`, `deleted_at`) VALUES (1, 'Dental Dent', 'dentaldent', 'Europe/Istanbul', NULL, NULL, NULL);
INSERT INTO `randevusaas`.`businesses` (`id`, `name`, `slug`, `timezone`, `created_at`, `updated_at`, `deleted_at`) VALUES (2, 'Super Dent', 'superdent', 'Europe/Istanbul', NULL, NULL, NULL);
...
START TRANSACTION;
USE `randevusaas`;
INSERT INTO `randevusaas`.`users` (`id`, `status`, `status_message`, `first_name`, `last_name`, `tcno`, `gsm`, `email`, `dogum_yili`, `tcnoverified`, `gsmverified`, `emailverified`, `language`, `superadmin`, `last_active`, `created_at`, `updated_at`, `deleted_at`) VALUES (1, NULL, NULL, 'Umut', 'Demirhan', '23416086000', '5330338197', 'umut@kariyerfora.com', 1977, false, false, false, NULL, 1, NULL, NULL, NULL, NULL);
INSERT INTO `randevusaas`.`users` (`id`, `status`, `status_message`, `first_name`, `last_name`, `tcno`, `gsm`, `email`, `dogum_yili`, `tcnoverified`, `gsmverified`, `emailverified`, `language`, `superadmin`, `last_active`, `created_at`, `updated_at`, `deleted_at`) VALUES (2, NULL, NULL, 'Hüseyin', 'Mumay', NULL, '5445868624', 'ideametrik@gmail.com', 1982, false, false, false, NULL, 1, NULL, NULL, NULL, NULL);
INSERT INTO `randevusaas`.`users` (`id`, `status`, `status_message`, `first_name`, `last_name`, `tcno`, `gsm`, `email`, `dogum_yili`, `tcnoverified`, `gsmverified`, `emailverified`, `language`, `superadmin`, `last_active`, `created_at`, `updated_at`, `deleted_at`) VALUES (3, NULL, NULL, 'Burhan', 'Çalhan', NULL, '5057958150', 'calhan.bur@gmail.com', 1981, false, false, false, NULL, 1, NULL, NULL, NULL, NULL);
